...
// 회원 ID 중복 확인
        ...
        UserIDCheck(password, username, passwordChcek, found);
...
// 사용자 ROLE 확인
   ...
   public static void UserIDCheck(String password, String username, String passwordChcek, Optional<User> found) {
